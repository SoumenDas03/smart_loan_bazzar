...
class RDCalculatorPge extends StatefulWidget {
  const RDCalculatorPge({super.key});

  @override
  State<RDCalculatorPge> createState() => _RDCalculatorPgeState();
}

class _RDCalculatorPgeState extends State<RDCalculatorPge> {
